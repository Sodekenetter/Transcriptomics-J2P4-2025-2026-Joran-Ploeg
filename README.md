...
Figuur 1: Workflow van de transcriptomische analyse. De RNA-sequencingdata werden geïndexeerd en uitgelijnd met Rsubread tegen het humane referentiegenoom GRCh38.p14, waarna een countmatrix werd opgesteld. Vervolgens werd differentiële genexpressie bepaald met DESeq2, gevolgd door GO-verrijkingsanalyse, KEGG pathway-analyse en visualisatie van de IL-17-signaleringsroute.

De analyse werd uitgevoerd in R. Het indexeren en aligneren van de RNA-sequencingdata werd uitgevoerd met Rsubread (v2.26.0), waarbij het humane referentiegenoom GRCh38.p14 (NCBI Assembly GCF_000001405.40) werd gebruikt. Differentiële genexpressie werd bepaald met DESeq2 (v1.52.0) ([Love 2014 DESeq2](Referenties/Love_2014_DESeq2.pdf)) en genen met een adjusted p-waarde < 0,01 werden als significant beschouwd. De volcano plot werd gegenereerd met EnhancedVolcano (v1.30.0) en ggplot2 (v4.0.3). Voor de GO-verrijkingsanalyse werden goseq (v1.64.0), geneLenDataBase (v1.48.0) en AnnotationDbi (v1.74.0) gebruikt ([Young 2010 GOseq](Referenties/Young_2010_GOseq.pdf)). Hierbij werden genen met een adjusted p-waarde < 0,01 en |log2FC| > 1 geselecteerd, waarna de verrijkte GO-termen met de Bonferroni-correctie werden gefilterd. De KEGG pathway-analyse werd uitgevoerd met clusterProfiler (v4.20.0) en org.Hs.eg.db (v3.23.1) op basis van genen met een adjusted p-waarde < 0,05 en |log2FC| > 1. De IL-17-signaleringsroute werd vervolgens gevisualiseerd met Pathview (v1.52.0) ([Luo 2013 Pathview](Referenties/Luo_2013_Pathview.pdf)).
...
Figuur 3: Verrijkte Gene Ontology (GO)-termen van de differentieel geëxpresseerde genen. De weergegeven termen voldeden aan een Bonferroni-gecorrigeerde adjusted p-waarde ≤ 0,01 en bevatten minimaal 15 differentieel geëxpresseerde genen. De x-as toont de GO-term en de y-as de −log10(FDR). De kleuren geven de GO-categorie weer (BP, CC of MF).
...
Figuur 4: Visualisatie van de IL-17-signaleringsroute (KEGG hsa04657). De pathway is gegenereerd met Pathview op basis van de log2 fold changes uit de differentiële genexpressieanalyse. Rode vakken geven relatief opgereguleerde genen weer en groene vakken relatief neergereguleerde genen in RA ten opzichte van gezonde controles.
